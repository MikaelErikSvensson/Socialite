...
function ViewSinglePost(props) {
  ...
  async function handleTrash() {
    const confirmTrash = window.confirm('Are you sure you want to delete this post?');
    if (confirmTrash) {
      try {
      ...
      <div className="d-flex justify-content-between">
        ...
        {isOwner() && (
          <span className="pt-2">
            ...
            <a onClick={handleTrash} data-tip="Delete" data-for="delete" className="delete-post-button text-danger">
